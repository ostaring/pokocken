...
vi.mock("../features/gallery/gallery-hooks", async () => {
  const actual = await vi.importActual<typeof import("../features/gallery/gallery-hooks")>(
    "../features/gallery/gallery-hooks",
  );
